...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktieren Sie Hamdan Sprachendienste – Ihren Arabisch-Deutsch Übersetzer und Dolmetscher. Büros in Dresden und Mannheim, bundesweit tätig. Anfrage per Formular oder E-Mail.",
  keywords: [
